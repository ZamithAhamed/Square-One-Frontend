...
const PatientDetailsModal: React.FC<Props> = ({ open, patient, onClose, onSchedule }) => {
  ...
  // keep notes in sync if patient prop changes
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-start justify-center p-4 md:p-8 overflow-y-auto">
        <div className="w-full max-w-5xl bg-gray-900 text-gray-100 rounded-2xl shadow-xl border border-gray-800">
          {/* Header */}
          <div className="flex items-center justify-between p-5 border-b border-gray-800">
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2 text-sm text-gray-300">
                    ...
                    {patient.patientId && (
                      <span className="inline-flex items-center gap-1 rounded-full bg-blue-500/15 px-2 py-0.5 text-blue-300 ring-1 ring-inset ring-blue-500/25">
            ...
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-green-500/15 px-3 py-1 text-sm font-medium text-green-300 ring-1 ring-inset ring-green-500/25">
                Active
              </span>
              <button
                onClick={onClose}
          ...
          <div className="px-6 pt-4 border-b border-gray-800">
            <div className="flex items-center gap-6">
              {tabs.map(t => (
                <button
                  key={t}
                  className={`pb-3 -mb-px border-b-2 text-sm focus:outline-none ${
                    tab === t
              ...
              {tab === 'Notes' && (
                <div className="ml-auto">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-lg border border-gray-700 px-3 py-1.5 text-sm text-gray-300 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                  >
          ...
          <div className="p-6">
            {tab === 'Overview' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-gray-900 rounded-xl p-5 border border-gray-800">
                  <h4 className="text-sm font-semibold text-gray-200 mb-3">Personal Information</h4>
                ...
                <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
                  <h4 className="text-sm font-semibold text-gray-200 mb-3">Medical Information</h4>
                  <div className="space-y-3 text-sm text-gray-300">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="pt-2">
                      <p className="font-medium text-gray-200">Blood Type</p>
                ...
                {/* Recent Appointments */}
                <div className="lg:col-span-3 bg-gray-900 rounded-xl border border-dashed border-gray-700 p-8 text-center text-gray-400">
                  <CalendarClock className="h-8 w-8 mx-auto mb-3 text-gray-600" />
            ...
            {tab === 'Notes' && (
              <div className="space-y-4">
                <h4 className="text-base font-semibold text-gray-100">Clinical Notes</h4>
                ...
                {notes.length > 0 && (
                  <div className="rounded-xl border border-gray-800 bg-gray-900">
                    {notes.map((n, i) => (
                      <div
                        key={n.id}
                        className={`flex items-start gap-3 p-4 ${i !== notes.length - 1 ? 'border-b border-gray-800' : ''}`}
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {n.id === latestId && (
                              <span className="text-[11px] rounded-full bg-blue-500/15 px-2 py-0.5 font-medium text-blue-300 ring-1 ring-inset ring-blue-500/25">
                                Latest
                              </span>
                            )}
                          </div>
          ...
          <div className="flex items-center justify-end gap-3 p-5 border-t border-gray-800">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-700 text-gray-300 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
            >
